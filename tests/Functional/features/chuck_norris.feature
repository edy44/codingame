Feature: Code with Chuck Norris Encryption

  Scenario: Encode C character
    Given a string "C"
    When I encrypt with Chuck Norris code
    Then I get the following code "0 0 00 0000 0 00"

  Scenario: Encode CC character
    Given a string "CC"
    When I encrypt with Chuck Norris code
    Then I get the following code "0 0 00 0000 0 000 00 0000 0 00"

  Scenario: Encode % character
    Given a string "%"
    When I encrypt with Chuck Norris code
    Then I get the following code "00 0 0 0 00 00 0 0 00 0 0 0"

  Scenario: Encode Chuck Norris' sentence
    Given a string "Chuck Norris' keyboard has 2 keys: 0 and white space."
    When I encrypt with Chuck Norris code
